  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: CurvedNavigationBar(
        ...
        height: 60.0,
        items: const <Widget>[
          Icon(Icons.account_circle, size: 30, color: Color.fromARGB(255, 115, 192, 255)),
          Icon(Icons.favorite, size: 30, color: Color.fromARGB(255, 115, 192, 255)),
          Icon(Icons.shopping_cart, size: 30, color: Color.fromARGB(255, 115, 192, 255)),
          Icon(Icons.notifications, size: 30, color: Color.fromARGB(255, 115, 192, 255)),
          Icon(Icons.home, size: 30, color: Color.fromARGB(255, 115, 192, 255)),
        ],
